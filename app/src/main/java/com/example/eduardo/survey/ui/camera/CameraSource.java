...
public class CameraSource {
    ...
    public void release() {
        ...
        Log.d(TAG, "releasing CameraSource");
    }
    ...
    public void stop() {
        ...
        synchronized (mCameraLock) {
            ...
            if (mProcessingThread != null) {
                // The orignal code had thread.join within try/catch. However the thread never
                //released.
    ...
    private class FrameProcessingRunnable implements Runnable {
        ...
        void setActive(boolean active) {
            synchronized (mLock) {
                mActive = active;
                mLock.notifyAll();
                Log.d(TAG, "FrameProcessingRunnable active: " + active);
            }
        }
            ...
            while (true) {
                ...
                synchronized (mLock) {
                    ...
                    if (!mActive) {
                        ...
                        // loop.
                        Log.d(TAG, "runnable FrameProcessing is not active and called to exit");
                        return;
                    }
